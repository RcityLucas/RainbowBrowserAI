...
async fn main() -> Result<()> {
    ...
    match cli.command {
        ...
        Commands::Navigate { url, screenshot, headless } => {
...
async fn navigate_and_screenshot(url: &str, screenshot: Option<String>, headless: bool) -> Result<()> {
    ...
    if let Some(path) = screenshot {
        ...
        let screenshot_data = browser.screenshot(browser::ScreenshotOptions::default()).await?;
...
async fn test_browser(headless: bool) -> Result<()> {
    ...
    let screenshot = browser.screenshot(browser::ScreenshotOptions::default()).await?;
