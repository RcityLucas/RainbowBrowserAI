...
Analysis:"#.to_string(),
    ...
    pub fn create_task_planning_prompt(
        ...
        self.create_prompt(
            ...
            &[
                ...
                (
                    "context",
                    serde_json::Value::String(self.build_context_string(context)?),
                ),
            ],
        )
    }
    ...
    pub fn create_element_identification_prompt(
        ...
        self.create_prompt(
            ...
            &[
                (
                    "target_description",
                    serde_json::Value::String(target_description.to_string()),
                ),
                (
                    "page_context",
                    serde_json::Value::String(self.build_context_string(page_context)?),
                ),
    ...
    pub fn create_data_extraction_prompt(
        ...
        self.create_prompt(
            ...
            &[
                ...
                (
                    "extraction_request",
                    serde_json::Value::String(extraction_request.to_string()),
                ),
                (
                    "page_content",
    ...
    pub fn create_page_analysis_prompt(
        ...
        self.create_prompt(
            ...
            &[
                ...
                (
                    "page_info",
                    serde_json::Value::String(self.build_context_string(page_info)?),
                ),
            ],
        )
    }
    ...
    pub fn create_error_analysis_prompt(
        ...
        self.create_prompt(
            ...
            &[
                (
                    "failed_action",
                    serde_json::Value::String(failed_action.to_string()),
                ),
                (
                    "error_message",
                ...
                (
                    "page_state",
                    serde_json::Value::String(page_state.to_string()),
                ),
    ...
    pub fn create_prompt(
        ...
        let template = self.templates.get(template_name).ok_or_else(|| {
            LLMError::ConfigError(format!("Template not found: {}", template_name))
        })?;
        ...
        debug!(
            "Created prompt from template '{}', estimated {} tokens",
            template_name,
            estimated_tokens
        );
...
mod tests {
    ...
    fn test_task_planning_prompt() {
        ...
        let prompt = engine
            .create_task_planning_prompt("Click the login button", &context)
            .unwrap();
    ...
    fn test_element_identification_prompt() {
        ...
        context.insert(
            ...
            serde_json::Value::String("Login Page".to_string()),
        );
        ...
        let prompt = engine
            .create_element_identification_prompt("login button", &context, &elements)
            .unwrap();
