...
// 重新导出核心类型
pub use unified_kernel::{UnifiedKernel, Session, SessionConfig, PerceptionMode};
pub use layered_perception::{LayeredPerception, PerceptionResult};
...
pub struct RainbowBrowserV8 {
    // 六大生命器官
    unified_kernel: Arc<UnifiedKernel>,
    layered_perception: Arc<LayeredPerception>,
    intelligent_action: Arc<IntelligentAction>,
    optimized_persistence: Arc<OptimizedPersistence>,
    performance_engine: Arc<PerformanceEngine>,
    stability_engine: Arc<StabilityEngine>,
}
